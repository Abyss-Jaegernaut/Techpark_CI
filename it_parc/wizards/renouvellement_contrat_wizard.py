...
class ItRenouvellementContratWizard(models.TransientModel):
    ...
    contract_id = fields.Many2one('it.contrat', string='Contrat', required=True)
    ...
    def action_renew(self):
        ...
        self.contract_id.message_post(body=_("Contrat renouvele jusqu'au %s.") % self.new_date_end)
